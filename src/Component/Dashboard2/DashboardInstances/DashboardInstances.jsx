...
const [loader , setLoader] = useState(true);
    ...
    return (
        <>
            <div className='main-dashboard-contant' style={{ marginTop: "1.5vh" }}>
                ...
                {/* Messages */}
                <div>
                    <h4 style={{ textAlign: 'start', margin: "10px 0 10px 5px", color: "white" }} 
                    >
                        Messages
                    </h4>
                </div>
                ...
                <div className="">
                    <div className='scroll-style'>
                        ...
                        <thead style={{marginBottom : "0px" , tableLayout : "fixed"}}>
                            <tr className='msg-body-dash'style={{ verticalAlign: "baseline", color: 'white' 
                         }}>
                                <td style={{ textAlign: "start", minWidth: "170px" , marginTop : "20px" , paddingLeft :"4rem"  }}>Name</td>
                                <td style={{ textAlign: "start", minWidth: "170px" , marginTop : "20px" , paddingLeft :"4rem" }}>Number</td>
                                <td style={{ textAlign: "start", minWidth: "170px" , marginTop : "20px" , paddingLeft :"4rem" }}>Time Stramp</td>
                                <td style={{ textAlign: "start", minWidth: "170px" , marginTop : "20px" , paddingLeft :"4rem" }}>Message</td>
                            </tr>
                        </thead>
                            ...
                            messageData?.map((message, index) => (
                                <tr className='msg-body-dash' key={index} style={{ verticalAlign: "baseline", color: 'white'  }}>
                                    <td style={{ textAlign: "start", minWidth: "170px" , marginTop : "20px" }}>
                                    ...
                                    <td style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        ...
                                        > */}
                                            <span data-tip={message?.message} data-for={`tooltip${index}`}>
