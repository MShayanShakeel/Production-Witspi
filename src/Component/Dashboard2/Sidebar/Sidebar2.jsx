          ...
          <>
            ...
            <Link
              ...
              className={`mb-2 main-sidebar2 ${
                window.location.pathname === "/dashboard2" ? "active-link" : ""
              }`}
              activeClass="active"
              spy={true}
              smooth={true}
            ...
            <Link
              to="/instances2"
              className={`mb-2 main-sidebar2 ${
                window.location.pathname === "/instances2" ? "active-link" : ""
              }`}
              activeClass="active"
              spy={true}
              smooth={true}
            ...
            <Link
              to="/myContact2"
              className={`mb-2 main-sidebar2 ${
                window.location.pathname === "/myContact2" ? "active-link" : ""
              }`}
              activeClass="active"
              spy={true}
              smooth={true}
            ...
            <Link
              ...
              className={`mb-2 main-sidebar2 broad-cast-icon ${
                window.location.pathname === "/createBroadCast2"
                  ? "active-link"
                  : ""
              }`}
              activeClass="active"
            ...
            <Link
              to="/Groups2"
              className={`mb-2 main-sidebar2 ${
                window.location.pathname === "/Groups2" ? "active-link" : ""
              }`}
              activeClass="active"
              spy={true}
              smooth={true}
            ...
            <Link
              to="/settings2"
              className={`mb-2 main-sidebar2 ${
                window.location.pathname === "/settings2" ? "active-link" : ""
              }`}
              activeClass="active"
              spy={true}
              smooth={true}
          ...
          <p>
            ...
            /> */}
              ...
              <Link
                to="/instances2"
                className={`mb-2 main-sidebar2 ${
                  window.location.pathname === "/instances2"
                    ? "active-link"
                    : ""
                }`}
                activeClass="active"
              ...
              <Link
                to="/myContact2"
                className={`mb-2 main-sidebar2 ${
                  window.location.pathname === "/myContact2"
                    ? "active-link"
                    : ""
                }`}
                activeClass="active"
