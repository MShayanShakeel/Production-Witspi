      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="">
              {loader && <Loader width={50} height={50} left={50} top={50}  />}
              <Link to="/groups2">
            <IoMdArrowRoundBack  style={{fontSize :"3vh " , marginTop : "0.5rem" , color : "white" ,marginBottom : "-1rem" , cursor: "pointer"}}/>
              </Link>
              <form>
                <div className="row textfield-row">
                  ...
                  <div
                    ...
                    style={{ marginTop: "20px" }}
                  >
                    <label className="lable-create-contact"><h3>Contact List</h3></label>
                    <label
                      className="contact-text-field Group-contact-list-Section"
                    >
                      {Array.isArray(singleGroupData?.message?.contactList) &&
                      singleGroupData?.message?.contactList.length > 0 ? (
                        singleGroupData?.message?.contactList.map(
                          (ListContact, index) => (
                            <li key={index} style={{ padding: "0.5rem" , display:"flex" , justifyContent : "space-between" }}>
                              <p style={{paddingTop : "1rem" , marginRight : "1rem"}}>{ListContact}</p>
                              <button
                                type="button"
